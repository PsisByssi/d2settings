...
|  
The Hp Toggler allows you to make use of the dota_health_per_vertical_marker command.

The toggle key is used to select the set of hp settings to load.
